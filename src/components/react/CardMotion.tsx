...
export const CardTitle = ({
  ...
  return <h3 className={cn('text-lg text-foreground py-2 font-bold', className)}>{children}</h3>
}
...
export const GeminiLogo = ({ className }: { className?: string }) => {
  return (
    <svg fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" className={className} aria-hidden="true">
      <path
