      ...
      <div>
        <div className="container py-24 lg:py-32">
          ...
          <div className="flex justify-center">
            <a className="inline-flex items-center gap-x-2 border text-sm p-1 ps-3 rounded-full transition" href="#">
          ...
          <div className="mt-5 flex justify-center items-center gap-x-1 sm:gap-x-3">
            ...
            <a className="inline-flex items-center gap-x-1 text-sm decoration-2 hover:underline font-medium" href="#">
              Installation Guide
