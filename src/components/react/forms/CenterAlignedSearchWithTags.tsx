      ...
      <div className="relative overflow-hidden">
        <div className="container py-24 lg:py-32">
          <div className="text-center">
            <h1 className="scroll-m-20 text-4xl font-extrabold tracking-tight lg:text-5xl">Insights</h1>
            <p className="mt-3 text-xl text-muted-foreground">Stay in the know with insights from industry experts.</p>
