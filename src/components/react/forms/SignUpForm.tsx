            ...
            <div>
              ...
              <div className="mt-4 md:mb-12 max-w-2xl">
                ...
                <p className="text-xl text-muted-foreground">
                  Experience limitless possibilities with our cutting-edge cloud solutions.
                </p>
              </div>
              {/* End Title */}
              {/* Blockquote */}
              <blockquote className="hidden md:block relative max-w-sm">
                ...
                <div className="relative z-10">
                  <p className="text-xl italic">Amazing people to work with. Very fast and professional partner.</p>
                </div>
                <footer className="mt-3">
                  <div className="flex items-center">
                    <div className="flex-shrink-0">
                      <img className="h-8 w-8 rounded-full" src="https://placehold.co/100x100" alt="Imag Description" />
                    </div>
                    <div className="grow ms-4">
                      <div className="font-semibold">Emily Torres</div>
                      <div className="text-xs text-muted-foreground">Chief Technology Officer | Skyward SaaS</div>
                    </div>
                  </div>
                </footer>
              </blockquote>
                ...
                <div className="lg:max-w-lg lg:mx-auto lg:me-0 ms-auto">
                  ...
                  <Card>
                    <CardHeader className="text-center">
                      <h2 className="text-2xl font-semibold leading-none tracking-tight">Start your free trial</h2>
                      <CardDescription>
                    ...
                    <CardContent>
                      ...
                      <div className="mt-5">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                          ...
                          <Input className="col-span-2" placeholder="New password" />
                          <Input className="col-span-2" placeholder="Current password" />
